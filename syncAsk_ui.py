...
class Ui_syncAsk(QtGui.QMainWindow):
    def __init__(self):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(60, 20, 501, 201))
        self.label.setText(_fromUtf8(""))
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8(os.getcwd()+"/datasync.jpg")))
...
"color: rgb(255, 255, 255);"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.openFileServer)
        self.pushButton_2.clicked.connect(self.openFileClient)
    
    def openFileServer(self):
        self.window = QtGui.QMainWindow()
        self.ui=Ui_fileSyncServer()
        self.ui.setupUi(self.window)
        self.window.show()
    
    def openFileClient(self):
        self.window = QtGui.QMainWindow()
        self.ui=Ui_fileSyncClient()
        self.ui.setupUi(self.window)
        self.window.show() 
