...
class Ui_askChat(QtGui.QMainWindow):
    def __init__(self):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label.setPixmap(QtGui.QPixmap(_fromUtf8(os.getcwd()+"/chat.png")))
...
"color: rgb(255, 255, 255);"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.openServer)
        self.pushButton_2.clicked.connect(self.openClient)
    
    def openServer(self):
        os.system("python host.pyw")
    
    def openClient(self):
        os.system("python client.pyw")
